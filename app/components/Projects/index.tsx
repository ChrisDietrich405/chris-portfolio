...
const Projects = () => {
  ...
  return (
    <Container sx={{ mt: 2 }} className={styles.container} ref={projectRef}>
      <h2 className={styles.title}>Projects</h2>
      <p>
        Click thumbnail to navigate to the website and the arrow to navigate to
        the Github repo
      </p>
      <Grid container>
        <Grid item></Grid>
      ...
      <div className={styles.grid_container}>
        <div className={styles.credentials}>
          <Link href="https://gcshop-b5488.web.app/" target="_blank">
            <Image
          ...
          <div>
            <div className={styles.title_container}>
              <p>CG Shop</p>
              <a href="https://github.com/ChrisDietrich405/cg.shop">
                <BsArrowUpRight />
              </a>
            </div>
            <ul>
      ...
      <div className={styles.grid_container}>
        <div className={styles.credentials}>
          <Link
            href="https://english-in-eight-minutes.web.app/"
            target="_blank"
          >
            <Image
